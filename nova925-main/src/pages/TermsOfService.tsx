...
export function TermsOfService() {
  usePageSEO({ title: 'Terms of Service', description: 'Terms of service and conditions of use for purchasing from NOVA Jewellery.' });
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
      ...
      <div className="container mx-auto px-6 md:px-12 py-16 max-w-4xl flex-1 text-nova-dark/70 text-sm font-light leading-relaxed">
        <div className="space-y-8">
          ...
          <div className="border-t border-nova-dark/10 pt-8">
            <h3 className="text-base font-serif font-medium text-nova-dark mb-3">Section 1 – Online Store Terms</h3>
            <p className="mb-3">
          ...
          {/* Section 2 */}
          <div className="border-t border-nova-dark/10 pt-8">
            <h3 className="text-base font-serif font-medium text-nova-dark mb-3">Section 2 – General Conditions</h3>
            <p className="mb-3">
            ...
            <p className="text-xs text-nova-dark/45 italic">
          ...
          {/* Section 3 */}
          <div className="border-t border-nova-dark/10 pt-8">
            <h3 className="text-base font-serif font-medium text-nova-dark mb-3">Section 3 – Accuracy, Completeness and Timeliness of Information</h3>
            <p className="mb-3">
          ...
          {/* Section 4 */}
          <div className="border-t border-nova-dark/10 pt-8">
            <h3 className="text-base font-serif font-medium text-nova-dark mb-3">Section 4 – Modifications to Services and Prices</h3>
            <p>
          ...
          {/* Section 5 */}
          <div className="border-t border-nova-dark/10 pt-8">
            <h3 className="text-base font-serif font-medium text-nova-dark mb-3">Section 5 – Products or Services</h3>
            <p className="mb-3">
          ...
          {/* Section 6 */}
          <div className="border-t border-nova-dark/10 pt-8">
            <h3 className="text-base font-serif font-medium text-nova-dark mb-3">Section 6 – Accuracy of Billing and Account Information</h3>
            <p className="mb-3">
          ...
          {/* Section 7 */}
          <div className="border-t border-nova-dark/10 pt-8">
            <h3 className="text-base font-serif font-medium text-nova-dark mb-3">Section 7 – Optional Tools</h3>
            <p className="mb-3">
          ...
          {/* Section 8 */}
          <div className="border-t border-nova-dark/10 pt-8">
            <h3 className="text-base font-serif font-medium text-nova-dark mb-3">Section 8 – Third-Party Links</h3>
            <p className="mb-3">
          ...
          {/* Section 9 */}
          <div className="border-t border-nova-dark/10 pt-8">
            <h3 className="text-base font-serif font-medium text-nova-dark mb-3">Section 9 – User Comments, Feedback and Other Submissions</h3>
            <p className="mb-3">
          ...
          {/* Section 10 */}
          <div className="border-t border-nova-dark/10 pt-8">
            <h3 className="text-base font-serif font-medium text-nova-dark mb-3">Section 10 – Personal Information</h3>
            <p>
          ...
          {/* Section 11 */}
          <div className="border-t border-nova-dark/10 pt-8">
            <h3 className="text-base font-serif font-medium text-nova-dark mb-3">Section 11 – Errors, Inaccuracies and Omissions</h3>
            <p className="mb-3">
          ...
          {/* Section 12 */}
          <div className="border-t border-nova-dark/10 pt-8">
            <h3 className="text-base font-serif font-medium text-nova-dark mb-3">Section 12 – Prohibited Uses</h3>
            <p className="mb-3">
          ...
          {/* Section 13 */}
          <div className="border-t border-nova-dark/10 pt-8">
            <h3 className="text-base font-serif font-medium text-nova-dark mb-3">Section 13 – Disclaimer of Warranties; Limitation of Liability</h3>
            <p className="mb-3">
          ...
          {/* Section 14 */}
          <div className="border-t border-nova-dark/10 pt-8">
            <h3 className="text-base font-serif font-medium text-nova-dark mb-3">Section 14 – Indemnification</h3>
            <p>
          ...
          {/* Section 15 */}
          <div className="border-t border-nova-dark/10 pt-8">
            <h3 className="text-base font-serif font-medium text-nova-dark mb-3">Section 15 – Severability</h3>
            <p>
          ...
          {/* Section 16 */}
          <div className="border-t border-nova-dark/10 pt-8">
            <h3 className="text-base font-serif font-medium text-nova-dark mb-3">Section 16 – Termination</h3>
            <p className="mb-3">
          ...
          {/* Section 17 */}
          <div className="border-t border-nova-dark/10 pt-8">
            <h3 className="text-base font-serif font-medium text-nova-dark mb-3">Section 17 – Entire Agreement</h3>
            <p className="mb-3">
          ...
          {/* Section 18 */}
          <div className="border-t border-nova-dark/10 pt-8">
            <h3 className="text-base font-serif font-medium text-nova-dark mb-3">Section 18 – Governing Law</h3>
            <p>
          ...
          {/* Section 19 */}
          <div className="border-t border-nova-dark/10 pt-8">
            <h3 className="text-base font-serif font-medium text-nova-dark mb-3">Section 19 – Changes to Terms of Service</h3>
            <p>
          ...
          {/* Section 20 */}
          <div className="border-t border-nova-dark/10 pt-8">
            <h3 className="text-base font-serif font-medium text-nova-dark mb-3">Section 20 – Contact Information</h3>
            <p className="mb-3">
          ...
          <div className="border-t border-nova-dark/10 pt-8 space-y-4">
            ...
            <div>
              ...
              <div className="bg-nova-dark/5 border border-nova-dark/10 p-4 rounded-xl mt-2">
                <h5 className="text-[10px] uppercase tracking-wider text-nova-gold font-bold mb-1.5">Return & Exchange Exclusions</h5>
                <p className="text-[11px] font-light leading-relaxed text-nova-dark/60">
          ...
          {/* Gift Card Terms */}
          <div className="border-t border-nova-dark/10 pt-8 space-y-4">
            <h3 className="text-base font-serif font-medium text-nova-dark mb-3">Terms and Conditions – Gift Cards</h3>
            ...
            <div className="bg-nova-dark/5 border border-nova-dark/10 p-5 rounded-2xl space-y-3 mt-4">
              <h4 className="text-xs uppercase tracking-widest text-nova-gold font-semibold">How to Redeem (Online Redemption)</h4>
              <ol className="list-decimal list-inside text-xs font-light space-y-1.5 text-nova-dark/70">
            ...
            <div className="bg-nova-dark/5 border border-nova-dark/10 p-5 rounded-2xl">
              ...
              <p className="text-xs font-light leading-relaxed text-nova-dark/70">
