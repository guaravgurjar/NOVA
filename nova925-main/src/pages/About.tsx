...
export function About() {
  usePageSEO({ title: 'About Us', description: 'Discover NOVA Jewellery by Utkarsh Jewellers — our story, craftsmanship heritage, and commitment to 925 sterling silver purity.' });
