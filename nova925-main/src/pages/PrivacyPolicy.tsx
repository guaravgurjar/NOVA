...
export function PrivacyPolicy() {
  usePageSEO({ title: 'Privacy Policy', description: 'Read NOVA Jewellery privacy policy regarding customer data protection, encryption, and usage.' });
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
      ...
      <div className="container mx-auto px-6 md:px-12 py-16 max-w-4xl flex-1 text-nova-dark/70 text-sm font-light leading-relaxed">
        <div className="space-y-8">
          ...
          <div className="border-t border-nova-dark/10 pt-8">
            <h2 className="text-lg font-serif tracking-wide text-nova-dark mb-4 uppercase">Personal Information We Collect</h2>
            <p className="mb-4">
          ...
          <div className="border-t border-white/5 pt-8">
            <h2 className="text-lg font-serif tracking-wide text-nova-dark mb-4 uppercase">How Do We Use Your Personal Information?</h2>
            <p className="mb-4">
          ...
          <div className="border-t border-white/5 pt-8">
            <h2 className="text-lg font-serif tracking-wide text-nova-dark mb-4 uppercase">How We Share Your Personal Information</h2>
            <p>
          ...
          <div className="border-t border-white/5 pt-8">
            <h2 className="text-lg font-serif tracking-wide text-nova-dark mb-4 uppercase">Behavioural Advertising</h2>
            <p className="mb-4">
          ...
          {/* DO NOT TRACK */}
          <div className="border-t border-white/5 pt-8">
            <h2 className="text-lg font-serif tracking-wide mb-4 uppercase text-nova-gold">Do Not Track</h2>
            <p>
          ...
          {/* DATA RETENTION */}
          <div className="border-t border-white/5 pt-8">
            <h2 className="text-lg font-serif tracking-wide text-nova-dark mb-4 uppercase">Data Retention</h2>
            <p>
          ...
          <div className="border-t border-white/5 pt-8">
            <h2 className="text-lg font-serif tracking-wide mb-4 uppercase text-nova-gold">Changes to This Policy</h2>
            <p>
          ...
          {/* CONTACT INFORMATION */}
          <div className="border-t border-white/5 pt-8">
            <h2 className="text-lg font-serif tracking-wide mb-4 uppercase text-nova-gold">Contact Us</h2>
            <p>
