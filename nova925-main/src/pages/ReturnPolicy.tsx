...
export function ReturnPolicy() {
  usePageSEO({ title: 'Return Policy', description: 'NOVA Jewellery return and exchange policy. Easy 7-day returns on all sterling silver jewellery.' });
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
      ...
      <div className="container mx-auto px-6 md:px-12 py-16 max-w-4xl flex-1">
        <div className="space-y-12">
          ...
          <div className="flex gap-6 items-start">
            ...
            <div>
              <h2 className="text-lg font-serif tracking-wide text-nova-dark mb-3">3. Replacement & Exchange</h2>
              <p className="text-nova-dark/70 text-sm font-light leading-relaxed">
          ...
          <div className="flex gap-6 items-start">
            ...
            <div>
              <h2 className="text-lg font-serif tracking-wide text-nova-dark mb-3">Order Cancellation</h2>
              <p className="text-nova-dark/70 text-sm font-light leading-relaxed">
          ...
          <div className="flex gap-6 items-start">
            ...
            <div>
              <h2 className="text-lg font-serif tracking-wide text-nova-dark mb-3">Empty Parcel & Missing Items Claims</h2>
              <p className="text-nova-dark/70 text-sm font-light leading-relaxed mb-3">
