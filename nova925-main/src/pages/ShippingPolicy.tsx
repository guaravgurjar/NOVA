...
export function ShippingPolicy() {
  usePageSEO({ title: 'Shipping Policy', description: 'Free shipping pan India on all NOVA Jewellery orders. Learn about delivery timelines, tracking, and packaging.' });
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
