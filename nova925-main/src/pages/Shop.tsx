...
export function Shop() {
  ...
  usePageSEO({
    title: activeCategory ? `${activeCategory.name} Collection` : 'Shop 925 Sterling Silver Jewellery',
    description: activeCategory
      ? `Browse our certified 925 sterling silver ${activeCategory.name.toLowerCase()} collection. Authentic hallmarked purity, free shipping, cash on delivery.`
      : 'Explore the full NOVA collection of 925 sterling silver rings, necklaces, earrings & bracelets.',
    keywords: activeCategory
      ? `buy 925 silver ${activeCategory.name.toLowerCase()}, ${activeCategory.name.toLowerCase()} jewellery India, hallmarked silver ${activeCategory.name.toLowerCase()}`
      : 'shop silver jewellery, 925 sterling silver store, luxury silver collection',
    canonicalPath: activeCategory ? `/category/${activeCategory.id}` : '/shop',
    ogType: 'website',
  });
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white  text-nova-dark">
      ...
      <div className="relative w-full h-[220px] md:h-[280px] bg-gradient-to-r from-nova-darker via-nova-dark to-nova-darker flex items-center overflow-hidden border-b border-nova-gold/10">
        ...
        <div className="container mx-auto px-6 md:px-12 max-w-7xl relative z-10 flex flex-col justify-center">
          ...
          <h1 className="text-3xl md:text-5xl font-serif tracking-wider mb-3">
            {activeCategory ? activeCategory.name : "All Category"}
          </h1>
      ...
      <div className="bg-nova-dark border-b border-white/5 py-4 overflow-x-auto hide-scrollbar">
        <div className="container mx-auto px-4 md:px-12 max-w-7xl flex items-center justify-start md:justify-center space-x-2 md:space-x-3 whitespace-nowrap snap-x snap-mandatory scroll-pl-4">
          <Link
            to="/shop"
            className={`px-5 py-2 rounded-full text-xs uppercase tracking-wider transition-all duration-300 ${!id
          ...
          {shopCategories.map(cat => (
            <Link
              key={cat.id}
              to={`/category/${cat.id}`}
              className={`px-5 py-2 rounded-full text-xs uppercase tracking-wider transition-all duration-300 ${id === cat.id
                ? 'bg-nova-gold text-nova-darker font-bold shadow-md shadow-nova-gold/20'
                : 'bg-white/5 text-white/75 hover:bg-white/10 hover:text-white border border-white/5'
                }`}
            >
      ...
      <div className="container mx-auto px-6 md:px-12 py-12 max-w-7xl flex-1">
            ...
            <div className="flex flex-wrap items-center gap-1 sm:gap-2 relative z-30">
              ...
              <div className="relative">
                <button
                  ...
                  className={`flex items-center gap-1.5 px-4 py-3 hover:text-nova-gold transition-colors tracking-wide ${openFilter === 'type' ? 'text-nova-gold border-b-2 border-nova-gold' : 'text-white/80'
              ...
              <div className="relative">
                <button
                  ...
                  className={`flex items-center gap-1.5 px-4 py-3 hover:text-nova-gold transition-colors tracking-wide ${openFilter === 'shopfor' ? 'text-nova-gold border-b-2 border-nova-gold' : 'text-white/80'
              ...
              <div className="relative">
                <button
                  ...
                  className={`flex items-center gap-1.5 px-4 py-3 hover:text-nova-gold transition-colors tracking-wide ${openFilter === 'color' ? 'text-nova-gold border-b-2 border-nova-gold' : 'text-white/80'
              ...
              <div className="relative">
                <button
                  ...
                  className={`flex items-center gap-1.5 px-4 py-3 hover:text-nova-gold transition-colors tracking-wide ${openFilter === 'metal' ? 'text-nova-gold border-b-2 border-nova-gold' : 'text-white/80'
              ...
              <div className="relative">
                <button
                  ...
                  className={`flex items-center gap-1.5 px-4 py-3 hover:text-nova-gold transition-colors tracking-wide ${openFilter === 'stone' ? 'text-nova-gold border-b-2 border-nova-gold' : 'text-white/80'
              ...
              <div className="relative">
                <button
                  ...
                  className={`flex items-center gap-1.5 px-4 py-3 hover:text-nova-gold transition-colors tracking-wide ${openFilter === 'style' ? 'text-nova-gold border-b-2 border-nova-gold' : 'text-white/80'
              ...
              <div className="relative">
                <button
                  ...
                  className={`flex items-center gap-1.5 px-4 py-3 hover:text-nova-gold transition-colors tracking-wide ${openFilter === 'subcat' ? 'text-nova-gold border-b-2 border-nova-gold' : 'text-white/80'
        ...
        {/* Product Grid */}
        {filtered.length > 0 ? (
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2.5 md:gap-4 lg:gap-8">
