...
export function CookieBanner() {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 md:bottom-6 md:left-auto md:right-8 md:max-w-md bg-nova-darker/95 backdrop-blur-md border border-nova-gold/20 p-4 md:p-5 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.6)] z-50 animate-in fade-in slide-in-from-bottom-5 duration-500" style={{ paddingBottom: 'max(1rem, env(safe-area-inset-bottom))' }}>
